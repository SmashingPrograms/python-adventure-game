...
def level_2(player1):
    ...
    user_input = input(f'Choose (A) To help Bowser, Choose (B) to decline ').upper()
    ...
    if user_input == 'A':
        ...
        user_input = input('choose(A) to accept the offer. Choose (B) to decline').upper()
        ...
        if user_input == 'A':
            ...
            change_exp(5)
            change_health(3)
            user_input = input('Choose (A) to accept the mushroom. Choose (B) to decline.').upper()
            ...
            if user_input == 'A':
                ...
                if user_input == 'A':
                    ...
                    if player1.exp > 50:
                        print("You knock out Luigi and rob him of 20 coins and his vaccum.")
                        change_exp(20)
                        change_bounty(world_items['vaccum'])
                        change_bounty
                    else:
                        print("Luigi jumps on your head for 4 damage and stuffs you in a nearby pipe")
                        player1.health -=4
        ...
        user_input = input('Choose (A) to help. Choose (B) to decline').upper()
        ...
        if user_input == 'A':
            ...
            user_input = input("To fight off Diddy and rob Donkey Kongs stash, choose (A). To go rob K-Rool choose (B).").upper()
